...
class StackProyectoAdmin(admin.ModelAdmin):
    """Admin de catálogo de stack tecnológico."""
...
class CategoriaProyectoAdmin(admin.ModelAdmin):
    """Admin de catálogo de categorías."""
...
class MetricaObjetivoAdmin(admin.ModelAdmin):
    """Admin de catálogo de métricas objetivo."""
...
class ProyectoAdmin(admin.ModelAdmin):
    """Admin del modelo central Proyecto."""
    ...
    fieldsets = (
        ('Identificación del Proyecto', {'fields': ('titulo', 'slug', 'fecha_proyecto')}),
        ('Contenido y Multimedia', {'fields': ('descripcion', 'contenido', 'imagen_url')}),
        ('Clasificación Técnica', {'fields': ('categoria', 'sector', 'stack')}),
        (
        ...
        ('Recursos Externos', {'fields': ('url_github', 'url_notebook', 'url_demo')}),
        ('Control de Visibilidad', {'fields': ('publicado', 'portada')}),
    )

    def mostrar_imagen(self, obj):
        """Renderiza thumbnail desde URL."""
